...
import LDDE from '../structures/LDDE.js';
import Drawable from '../base_classes/Drawable.js';

class LDDEPage extends React.Component {
    constructor(props){
        super(props);
        ...
        this.state = {
            ...
            labels: ["Inserir", "Inserir", "Remover", "Busca"],
        };
    ...
    handleCanvas = (Canvas) => {
        if (Canvas != null){
            ...
            this.ldde = new LDDE(this.canvas, null, null, 20, 20, 80, 40, '#b5b5aa', 30);
        }
    }
    ...
    handleOperation = () => {
        ...
        //Insert operation
        if (this.state.operationValue === "insert"){
            this.ldde.insert(this.state.nodeValue);
            this.ldde.draw();
        }
        
        //Remove operation
        else if (this.state.operationValue === "remove"){ alert(this.updateMessage) }

        //Search operation
        else {
            this.ldde.search(this.state.nodeValue);
            this.ldde.draw();
        }
            ...
            <View style={Standard.container}>
                ...
                <View style={Standard.topContent}>
                    ...
                    <View style={Standard.titleContainer}>
                        <Text style={Standard.titleText}>{"LDDE"}</Text>
                    </View>
                </View>
                        ...
                        <View style={Standard.comboBoxContainer}>
                            ...
                            <View style={{borderRadius: 5}}>
                                ...
                                >
                                    ...
                                    <Picker.Item label="Busca" value="search" />
                                </Picker>
                            </View>
...
export default withNavigation(LDDEPage);